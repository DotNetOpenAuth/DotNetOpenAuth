<%@ Control Language="C#" AutoEventWireup="true" Inherits="ProfileFields" CodeFile="ProfileFields.ascx.cs" %>
This consumer has requested the following fields from you<br />
<table>
	<tr>
		<td>&nbsp; </td>
		<td><asp:HyperLink ID="privacyLink" runat="server" Text="Privacy Policy" Target="_blank" />
		</td>
	</tr>
	<tr runat="server" id="nicknameRow">
		<td>Nickname <asp:Label ID="nicknameRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td><asp:TextBox ID="nicknameTextBox" runat="server"></asp:TextBox> </td>
	</tr>
	<tr runat="server" id="emailRow">
		<td>Email <asp:Label ID="emailRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td><asp:TextBox ID="emailTextBox" runat="server"></asp:TextBox> </td>
	</tr>
	<tr runat="server" id="fullnameRow">
		<td>FullName <asp:Label ID="fullnameRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td><asp:TextBox ID="fullnameTextBox" runat="server"></asp:TextBox> </td>
	</tr>
	<tr runat="server" id="dateOfBirthRow">
		<td>Date of Birth <asp:Label ID="dobRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td>
	...
	<tr runat="server" id="genderRow">
		<td>Gender <asp:Label ID="genderRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td>
	...
	<tr runat="server" id="postcodeRow">
		<td>Post Code <asp:Label ID="postcodeRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td><asp:TextBox ID="postcodeTextBox" runat="server"></asp:TextBox> </td>
	</tr>
	<tr runat="server" id="countryRow">
		<td>Country <asp:Label ID="countryRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td>
	...
	<tr runat="server" id="languageRow">
		<td>Language <asp:Label ID="languageRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td>
	...
	<tr runat="server" id="timezoneRow">
		<td>Timezone <asp:Label ID="timezoneRequiredLabel" runat="server" Text="*" Visible="False"></asp:Label>
		</td>
		<td>
	...
	<tr>
		<td colspan="2">Note: Fields marked with a * are required by the consumer </td>
	</tr>
</table>
