...
namespace DotNetOpenAuth.OpenId.RelyingParty {
	...
	internal class StandardRelyingPartyApplicationStore : IRelyingPartyApplicationStore {
		...
		/// </summary>
		private readonly NonceMemoryStore nonceStore;

		/// <summary>
		/// The association store to use.
		/// </summary>
		private readonly AssociationMemoryStore<Uri> associationStore;

		/// <summary>
		/// The private secret store to use.
		/// </summary>
		private readonly PrivateSecretMemoryStore privateSecretStore;
