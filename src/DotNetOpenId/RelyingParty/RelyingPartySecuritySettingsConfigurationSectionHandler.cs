...
namespace DotNetOpenId.RelyingParty {
	public sealed class RelyingPartySecuritySettingsConfigurationSectionHandler : ConfigurationSection {
		public RelyingPartySecuritySettingsConfigurationSectionHandler() {
		}
